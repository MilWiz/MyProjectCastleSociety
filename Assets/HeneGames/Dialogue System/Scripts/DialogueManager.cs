...
namespace HeneGames.DialogueSystem
{
    public class DialogueManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (InputManager.instance.InterractButton && dialogueTrigger != null && !dialogueIsOn)
            {
        ...
        public void StartDialogue()
        {
            ...
            //Play dialogue sound
            PlayNPCSounds(sentences[currentSentence].eventPath);
        ...
        public void PlayNPCSounds(FMODUnity.EventReference p)
        {
            EventInstance soundInstance = RuntimeManager.CreateInstance(p);
            //RuntimeManager.AttachInstanceToGameObject(soundInstance, this.gameObject.transform, false);
            soundInstance.set3DAttributes(RuntimeUtils.To3DAttributes(this.gameObject.transform));
        ...
        public int CurrentSentenceLenght()
        {
            ...
            return sentences[currentSentence].sentence.text.Length;
        }
    }
