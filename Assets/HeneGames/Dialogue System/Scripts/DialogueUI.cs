...
namespace HeneGames.DialogueSystem
{
    public class DialogueUI : MonoBehaviour
    {
        ...
        private bool typing;
        private TMPro.TMP_Text currentMessage;
        ...
        public virtual void InputUpdate()
        {
            ...
            if (InputManager.instance.InterractButton) 
            {
                NextSentenceSoft();
            }
        }
        ...
        public void ShowSentence(DialogueCharacter _dialogueCharacter, TMPro.TMP_Text _message)
        {
            StopAllCoroutines();
        ...
        IEnumerator WriteTextToTextmesh(TMPro.TMP_Text _text, TextMeshProUGUI _textMeshObject)
        {
            typing = true;

            _textMeshObject.text = "";
            char[] _letters = _text.text.ToCharArray();
